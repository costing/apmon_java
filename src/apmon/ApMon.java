...
public class ApMon {
     ...
     * ApMon version
     */
    public static final String APMON_VERSION = "2.2.7";

    /**
     * Max UDP datagram size
     */
    public static final int MAX_DGRAM_SIZE = 8192;	// TODO: raise it to 65500 (less than 64K otherwise the full UDP packet is too large) after GeneridUDPListener is deployed with a similarly large value
    ...
    Vector<String> netInterfaces = new Vector<String>();

    /** The IPs of this machine. */
    Vector<String> allMyIPs = new Vector<String>();
     ...
     * Monitored jobs
     */
    Vector<MonitoredJob> monJobs = new Vector<MonitoredJob>();
    ...
    private static Map<String, Integer> mValueTypes = new HashMap<String, Integer>();
    ...
    void initialize(String filename, boolean firstTime) throws ApMonException, SocketException, IOException {
        Vector<String> vdestAddresses = new Vector<String>();
        Vector<Integer> vdestPorts = new Vector<Integer>();
        Vector<String> vdestPasswds = new Vector<String>();

        Hashtable<Object, Long> confRes = new Hashtable<Object, Long>();
        try {
    ...
    private void arrayInit(Vector<String> adresses, Vector<Integer> ports, Vector<String> passwds, boolean firstTime) throws ApMonException, SocketException, IOException {
        ...
        tmpAddresses = new Vector<String>();
        tmpPorts = new Vector<Integer>();
        tmpPasswds = new Vector<String>();
        ...
        synchronized (this) {
            this.destPorts = new Vector<Integer>(tmpPorts);
            this.destAddresses = new Vector<String>(tmpAddresses);
            this.destPasswds = new Vector<String>(tmpPasswds);
        }
     ...
     * @throws SocketException 
     * @throws IOException */
    public void sendTimedParameters(String clustername, String nodename, int nParams, Vector<String> paramNames, Vector<?> valueTypes, Vector<Object> paramValues, int timestamp) throws ApMonException, UnknownHostException, SocketException, IOException {
     ...
     * @throws UnknownHostException 
     * @throws SocketException 
     * @throws IOException partial_start
     */
    public synchronized void sendTimedParameters(String clustername, String nodename, int nParams, Vector<String> paramNames, Vector<Object> paramValues, int timestamp) throws ApMonException, UnknownHostException, SocketException, IOException {
        ...
        do{
	        ...
	        for (i = 0; i < destAddresses.size(); i++) {
	            ...
	            if (logger.isLoggable(Level.FINE)) {
	                ...
	                sbLogMsg.append(" sent to ").append(destAddresses.get(i)).append(", cluster = ").append(this.clusterName).append(", node = ").append(this.nodeName).append(", containing parameters:\n");
     ...
     * @throws SocketException 
     * @throws IOException */
    public void sendParameters(String clustername, String nodename, int nParams, Vector<String> paramNames, Vector<?> valueTypes, Vector<Object> paramValues) throws ApMonException, UnknownHostException, SocketException, IOException {
     ...
     * @throws IOException 
     */
    public void sendParameters(String clustername, String nodename, int params, Vector<String> paramNames, Vector<Object> paramValues) throws ApMonException, UnknownHostException, SocketException, IOException {
    ...
    public Double getSystemParameter(final String paramName) {
        ...
        HashMap<Long, String> hms = bkThread.monitor.getHashParams();
        if (hms == null) {
    ...
    private static final String levels_s[] = {
            "FATAL", "WARNING", "INFO", "FINE", "FINER", "FINEST", "DEBUG", "ALL", "OFF", "CONFIG"
    };
    
    private static final Level levels[] = {
            Level.SEVERE, Level.WARNING, Level.INFO, Level.FINE, Level.FINER, Level.FINEST, Level.FINEST, Level.ALL, Level.OFF, Level.CONFIG
    };
